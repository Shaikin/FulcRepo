...
public class Transmittals_New_Correspondence extends TestSuiteBase{

	private String local_testcaseName=Transmittals_New_Correspondence.class.getSimpleName();	
	String input="";
...
//Dialogs.browse(browserName, "C:\\Users\\Khaleel\\Desktop\\TestingFromAutomation.docx", "Business Case - All Documents")	;		
	...
	public static void TestTransmittals_New_Correspondence(Hashtable<String,String>data
			) throws Throwable{
		...
		try{
			...
			returnData=Transmittals_EntryPage.newItem(driver_TRANS, refID,testcaseName,worflow_l1,  data);
